...
/***/ "./node_modules/@unikka/loginas-api/dist sync recursive":
/*!****************************************************!*\
  !*** ./node_modules/@unikka/loginas-api/dist sync ***!
  \****************************************************/
/*! no static exports found */
...
webpackEmptyContext.id = "./node_modules/@unikka/loginas-api/dist sync recursive";
...
var require;parcelRequire=function(e,r,t,n){var i,o="function"==typeof parcelRequire&&parcelRequire,u="function"==typeof require&&require;function f(t,n){if(!r[t]){if(!e[t]){var i="function"==typeof parcelRequire&&parcelRequire;if(!n&&i)return i(t,!0);if(o)return o(t,!0);if( true&&"string"==typeof t)return __webpack_require__("./node_modules/@unikka/loginas-api/dist sync recursive")(t);var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}p.resolve=function(r){return e[t][1][r]||r},p.cache={};var l=r[t]=new f.Module(t);e[t][0].call(l.exports,p,l,l.exports,this)}return r[t].exports;function p(e){return f(p.resolve(e))}}f.isParcelRequire=!0,f.Module=function(e){this.id=e,this.bundle=f,this.exports={}},f.modules=e,f.cache=r,f.parent=o,f.register=function(r,t){e[r]=[function(e,r){r.exports=t},{}]};for(var c=0;c<t.length;c++)try{f(t[c])}catch(e){i||(i=e)}if(t.length){var l=f(t[t.length-1]); true?module.exports=l:undefined}if(parcelRequire=f,i)throw i;return f}({"hKzT":[function(require,module,exports) {
...
},{}],"hPjX":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),Object.defineProperty(exports,"isNil",{enumerable:!0,get:function(){return e.default}});var e=r(require("./isNil"));function r(e){return e&&e.__esModule?e:{default:e}}
},{"./isNil":"hKzT"}],"Focm":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=require("./Helper");function r(e,r,t,n,a,i,s){try{var o=e[i](s),u=o.value}catch(c){return void t(c)}o.done?r(u):Promise.resolve(u).then(n,a)}function t(e){return function(){var t=this,n=arguments;return new Promise(function(a,i){var s=e.apply(t,n);function o(e){r(s,a,i,o,u,"next",e)}function u(e){r(s,a,i,o,u,"throw",e)}o(void 0)})}}function n(e){throw new TypeError('"'+e+'" is read-only')}function a(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function i(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function s(e,r,t){return r&&i(e.prototype,r),t&&i(e,t),e}var o=function(){function r(t,i){if(a(this,r),(0,e.isNil)(t)){var s="Tried to create API service without a base uri. ";s+=(n("pathError"),"Please initialize the API service with a base path "),s+=(n("pathError"),'like "/neos/impersonate/"'),console.error(s)}if(this._basePath=t,(0,e.isNil)(i)){var o="Tried to create API service without a CSFR ";o+=(n("csrfError"),"token. Please initialize the API service with a token"),console.error(o)}this._csrfToken=i}return s(r,[{key:"callUserChange",value:function(){var e=t(regeneratorRuntime.mark(function e(r){var t,n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t={user:r,format:"json"},e.next=3,fetch(this._basePath+"user-change",{method:"POST",credentials:"include",headers:this._getHeader(),body:JSON.stringify(t)});case 3:return n=e.sent,e.next=6,n.json();case 6:return e.abrupt("return",e.sent);case 7:case"end":return e.stop()}},e,this)}));return function(r){return e.apply(this,arguments)}}()},{key:"callStatus",value:function(){var e=t(regeneratorRuntime.mark(function e(){var r;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,fetch(this._basePath+"status",{method:"GET",credentials:"include",headers:this._getHeader()});case 2:return r=e.sent,e.next=5,r.json();case 5:return e.abrupt("return",e.sent);case 6:case"end":return e.stop()}},e,this)}));return function(){return e.apply(this,arguments)}}()},{key:"callRestore",value:function(){var e=t(regeneratorRuntime.mark(function e(){var r;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,fetch(this._basePath+"restore",{method:"POST",credentials:"include",headers:this._getHeader()});case 2:return r=e.sent,e.next=5,r.json();case 5:return e.abrupt("return",e.sent);case 6:case"end":return e.stop()}},e,this)}));return function(){return e.apply(this,arguments)}}()},{key:"_getHeader",value:function(){return{Accept:"application/json","Content-Type":"application/json","X-Flow-Csrftoken":this._csrfToken}}}]),r}();exports.default=o;
},{"./Helper":"hPjX"}]},{},["Focm"], null)
//# sourceMappingURL=/index.js.map
...
/***/ "./src/component/ExtendedUserDropDown.js":
/*!***********************************************!*\
  !*** ./src/component/ExtendedUserDropDown.js ***!
  \***********************************************/
/*! no static exports found */
...
var _loginasApi = __webpack_require__(/*! @unikka/loginas-api */ "./node_modules/@unikka/loginas-api/dist/index.js");

var _loginasApi2 = _interopRequireDefault(_loginasApi);
...
var _dropdown = __webpack_require__(/*! ./dropdown.css */ "./src/component/dropdown.css");

var _dropdown2 = _interopRequireDefault(_dropdown);

var _RestoreButtonItem = __webpack_require__(/*! ./RestoreButtonItem */ "./src/component/RestoreButtonItem.js");

var _RestoreButtonItem2 = _interopRequireDefault(_RestoreButtonItem);
...
var BASE_PATH = '/neos/impersonate/';

var ExtendedUserDropDown = (_dec = (0, _reactRedux.connect)((0, _plowJs.$transform)({
    userName: (0, _plowJs.$get)('user.name.fullName')
}), {
    addFlashMessage: _neosUiReduxStore.actions.UI.FlashMessages.add
}), _dec2 = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
        i18nRegistry: globalRegistry.get('i18n')
    };
}), _dec3 = (0, _reactCssThemr.themr)('ExtendedUserDropDown', _dropdown2.default), _dec(_class = _dec2(_class = _dec3(_class = (_temp = _class2 = function (_PureComponent) {
    _inherits(ExtendedUserDropDown, _PureComponent);

    function ExtendedUserDropDown(props) {
        _classCallCheck(this, ExtendedUserDropDown);

        var _this = _possibleConstructorReturn(this, (ExtendedUserDropDown.__proto__ || Object.getPrototypeOf(ExtendedUserDropDown)).call(this, props));

        _this.state = { originUser: null, activeImpersonation: false };
        return _this;
    }

    _createClass(ExtendedUserDropDown, [{
        ...
        value: function componentDidMount() {
            ...
            var apiService = new _loginasApi2.default(BASE_PATH, csrfToken);
            apiService.callStatus().then(function (data) {
                var origin = data.origin,
                    status = data.status;

                var newState = { activeImpersonation: status };
        ...
        value: function render() {
            var _state = this.state,
                originUser = _state.originUser,
                activeImpersonation = _state.activeImpersonation;
            var _props = this.props,
                neos = _props.neos,
                i18nRegistry = _props.i18nRegistry,
                addFlashMessage = _props.addFlashMessage;

            var logoutUri = (0, _plowJs.$get)('routes.core.logout', neos);
            var userSettingsUri = (0, _plowJs.$get)('routes.core.modules.userSettings', neos);
            var csrfToken = document.getElementById('appContainer').dataset.csrfToken;


            return _react2.default.createElement(
                'div',
                { className: _dropdown2.default.wrapper },
                _react2.default.createElement(
                    _reactUiComponents.DropDown,
                    { className: _dropdown2.default.dropDown },
                    _react2.default.createElement(
                        _reactUiComponents.DropDown.Header,
                        { className: _dropdown2.default.dropDown__btn },
                        _react2.default.createElement(_reactUiComponents.Icon, {
                            className: _dropdown2.default.dropDown__btnIcon,
                            icon: 'user'
                        }),
                        _react2.default.createElement(
                            'span',
                            { className: _dropdown2.default.dropDown__userName },
                            this.props.userName
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        {
                            className: _dropdown2.default.dropDown__contents
                        },
                        _react2.default.createElement(
                            'li',
                            { className: _dropdown2.default.dropDown__item },
                            _react2.default.createElement(
                                'form',
                                {
                                    title: 'Logout',
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(_reactUiComponents.Icon, {
                                        icon: 'sign-out-alt',
                                        'aria-hidden': 'true',
                                        className: _dropdown2.default.dropDown__itemIcon
                                    }),
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { title: 'User Settings', href: userSettingsUri },
                                _react2.default.createElement(_reactUiComponents.Icon, {
                                    icon: 'wrench',
                                    'aria-hidden': 'true',
                                    className: _dropdown2.default.dropDown__itemIcon
                        ...
                        activeImpersonation ? _react2.default.createElement(_RestoreButtonItem2.default, {
                            user: originUser,
...
var extendUserDropDown = function extendUserDropDown(OriginalUserDropDown) {
    return ExtendedUserDropDown;
};

exports.default = extendUserDropDown;

/***/ }),

/***/ "./src/component/RestoreButtonItem.js":
/*!********************************************!*\
  !*** ./src/component/RestoreButtonItem.js ***!
  \********************************************/
/*! no static exports found */
...
var restoreUser = function restoreUser(i18nRegistry, addFlashMessage) {
    console.log('restore origin user');
    var csrfToken = document.getElementById('appContainer').dataset.csrfToken;

    new _loginasApi2.default(BASE_PATH, csrfToken).callRestore().then(function (data) {
        var origin = data.origin,
            impersonate = data.impersonate;

        var restoreMessage = i18nRegistry.translate('success.restoreUser', 'Switched back from {0} to the orginal user {1}.', {
            0: impersonate.accountIdentifier,
            1: origin.accountIdentifier
        }, 'Unikka.LoginAs', 'Main');
        addFlashMessage('restoreUserImpersonateUser', restoreMessage, 'success');
        ...
        var errorMessage = i18nRegistry.translate('error.restoreUser', 'Could not switch back to the original user.', {}, 'Unikka.LoginAs', 'Main');
        addFlashMessage('restoreUserImpersonateUser', errorMessage, 'error');
    });
};

var RestoreButtonItem = function RestoreButtonItem(props) {
    var user = props.user,
        i18nRegistry = props.i18nRegistry,
        addFlashMessage = props.addFlashMessage;


    var title = i18nRegistry.translate('title.restoreUserButton', 'Switch back to the orginal user account', {}, 'Unikka.LoginAs', 'Main');
        ...
        _react2.default.createElement(
            'button',
            {
                ...
                onClick: function onClick() {
                    return restoreUser(i18nRegistry, addFlashMessage);
                }
            },
            _react2.default.createElement(_reactUiComponents.Icon, {
                icon: 'random',
...
exports.default = RestoreButtonItem;

/***/ }),

/***/ "./src/component/dropdown.css":
/*!************************************!*\
  !*** ./src/component/dropdown.css ***!
  \************************************/
/*! no static exports found */
...
module.exports = {"wrapper":"dropdown__wrapper___2QDVx","dropDown":"dropdown__dropDown___x_Kyu","dropDown__btn":"dropdown__dropDown__btn___1St5y","dropDown__btnIcon":"dropdown__dropDown__btnIcon___3EvAt","dropDown__userName":"dropdown__dropDown__userName___1pE1V","dropDown__contents":"dropdown__dropDown__contents___B5E1n","dropDown__item":"dropdown__dropDown__item___3kntp","dropDown__itemIcon":"dropdown__dropDown__itemIcon___3p3T4","dropDown__itemIcon__svg":"dropdown__dropDown__itemIcon__svg___2KFGR"};
...
var _ExtendedUserDropDown = __webpack_require__(/*! ./component/ExtendedUserDropDown */ "./src/component/ExtendedUserDropDown.js");

var _ExtendedUserDropDown2 = _interopRequireDefault(_ExtendedUserDropDown);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('Unikka.LoginAs:LoginAsUserMenu', {}, function (globalRegistry) {
    var containerRegistry = globalRegistry.get('containers');

    var OriginalUserDropDown = containerRegistry.get('PrimaryToolbar/Right/UserDropDown');

    containerRegistry.set('PrimaryToolbar/Right/UserDropDown', (0, _ExtendedUserDropDown2.default)(OriginalUserDropDown));
});
